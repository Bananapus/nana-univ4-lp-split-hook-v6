...
- Start here, then decide whether the issue is still in accumulation mode, already in post-deployment burn-and-manage mode, or actually in clone/deployer setup. The lifecycle stage matters more than the file layout.
