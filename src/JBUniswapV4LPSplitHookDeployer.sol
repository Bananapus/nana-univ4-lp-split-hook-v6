...
contract JBUniswapV4LPSplitHookDeployer is IJBUniswapV4LPSplitHookDeployer {
    ...
    JBUniswapV4LPSplitHook public immutable override hookImplementation;
    ...
    IHooks public immutable override oracleHook;
    ...
    /// @param newHookImplementation The `JBUniswapV4LPSplitHook` implementation all clones should use.
