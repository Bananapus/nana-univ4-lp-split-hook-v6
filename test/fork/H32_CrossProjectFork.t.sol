...
/// @notice Fork test proving H-32 fix: per-project balance isolation via snapshot-delta.
///         Two projects share the same hook clone. Deploying project A's pool must not
///         consume project B's accumulated tokens.
contract H32_CrossProjectFork is Test {
    ...
    /// @notice Two projects share the same hook clone. Deploy project A's pool and verify
    ///         project B's accumulated tokens are untouched.
    function test_fork_h32_crossProjectIsolation() public {
        // Project A: accumulate tokens and build surplus.
        ...
        // Project B: accumulate tokens (different project, same hook clone).
        ...
        // Record project B's token balance before project A deploys.
        ...
        // Verify project B's tokens are UNTOUCHED.
